...
public class Rectangle {
    ...
    /**
     * Gets the percent from 0 to 100 that is covered by the overlap between the rectangles.
     *
     * @param otherRectangle The other rectangle to get overlap with.
     * @return A number from 0 to 100 representing the overlap between this rectangle and the other rectangle.
     */
